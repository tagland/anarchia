...
public class Metadata extends Storable {
	...
	public static Metadata defaultMetatdata() {
		Metadata result = new Metadata();
		
		result.copyright = new Copyright();
		result.copyright.setDate(Date.createDateCreated());
		
		result.dates = new StorableComposite("", "dates");
		result.dates.addElement(Date.createDateCreated());
		
		result.adNasty = new AdNasty();
		return result;
	}

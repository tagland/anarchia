...
public class Author extends StorableComposite {
    ...
    private Map<String,String> frameIDs = new HashMap<String,String>();
    public void addFrameID(String frameID){
    	frameIDs.put(frameID, "");
    }
    /** @return the actual backing map of frame ids, do NOT modify */
    public Map<String, String> getFrameIDs(){
    	return frameIDs;
    }
    public boolean hasFrameID(String id){
    	return (frameIDs.get(id) != null);
    }
    ...
    //TODO: This is temporary: these should really go in Frame :: Panel :: ImageGroup :: Image

    private List<ImageGroup> imageGroups = new ArrayList<ImageGroup>();
	public List<ImageGroup> getImageGroups() {
		return imageGroups;
	}
	public void setImageGroups(List<ImageGroup> value) {
		imageGroups = value;
	}
    public void initImageGroups(){
         imageGroups = new ArrayList<ImageGroup>();
    }



	public String toString(){
		return "Author["+getID()+"];"+fullName+':'+familiarName+";websites:{"+websites+'}'+";debugNotes:"+debugNotes;
	}
